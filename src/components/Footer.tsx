...
const Footer = () => {
  return (
    <footer className="bg-gray-900 text-white py-16 px-6 md:px-12 lg:px-0">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="md:col-span-1">
            <a href="/" className="text-2xl font-display font-bold tracking-tight">
              Nova<span className="text-blue-400">Grid</span>
            </a>
            <p className="mt-4 text-gray-400 text-sm">
              Simplify your data experience with the next generation grid system.
            </p>
          </div>
          
          <div className="md:col-span-3 grid grid-cols-2 md:grid-cols-3 gap-8">
            <div>
              <h3 className="font-medium mb-4 text-gray-200">Product</h3>
            ...
            <div>
              <h3 className="font-medium mb-4 text-gray-200">Company</h3>
              <ul className="space-y-3">
            ...
            <div>
              <h3 className="font-medium mb-4 text-gray-200">Legal</h3>
              <ul className="space-y-3">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {new Date().getFullYear()} NovaGrid. All rights reserved.
          </p>
